...
def main():
  ...
  call_system('./visualize_skills.py')
  call_system('convert -density 300 -background white -alpha remove -bordercolor black -border 2x2 skills.pdf ../docs/assets/img/skills_onthology.png')
